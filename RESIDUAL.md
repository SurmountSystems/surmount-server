...
per-site v3 onions for apex, www, services, extra static Hosts, and
MTA-STS (mail unmapped); Tor Browser verify
...
- **Onion-Location + Alt-Svc (2026-08-17; every public Host 2026-08-20):**
  ...
  Onion-Location is `http://{that-host-onion}{path}`; onion-side Host
  rewrite serves that site. Mail stays unmapped.
  ...
  proven 2026-08-20 after `deploy-host` (then a shared v3). Tree 2026-09-11
  is per-site onions. Vaultwarden
