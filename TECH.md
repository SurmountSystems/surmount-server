...
- L1 main session
  - L2 Complete wrap and issue
    - L3 specialists (when spawned)
  - L2 DNS zone live setHosts
    - L3 specialists (when spawned)
  ...
  - L2 Implement Splora portal Host
    - L3 specialists (when spawned)
  - L2 Implement domains inventory union
    - L3 specialists (when spawned)
  - L2 Implement per-site v3 onions
    - L3 specialists (when spawned)
  - L2 Inventory onion Hosts
    - L3 specialists (when spawned)
  - L2 Issue cert from laptop
    - L3 specialists (when spawned)
  - L2 List Namecheap-updated zones
    - L3 specialists (when spawned)
  - L2 Map TLS cert names
    - L3 specialists (when spawned)
  ...
  - L2 Per-site onion implementer
    - L3 specialists (when spawned)
  - L2 Per-site onion services
    - L3 specialists (when spawned)
  - L2 Per-site onion services
    - L3 specialists (when spawned)
  - L2 Pin 20-name leaf docs
    - L3 specialists (when spawned)
  - L2 Restore exophiles cert names
    - L3 specialists (when spawned)
  - L2 Restore exophiles on cert
    - L3 specialists (when spawned)
  - L2 Review Splora portal Host
    - L3 specialists (when spawned)
  ...
  - L2 Union domains inventory
    - L3 specialists (when spawned)
  - L2 Update living leaf docs
    - L3 specialists (when spawned)
  - L2 Wait for cert issue
    - L3 specialists (when spawned)
...
| Implement per-site v3 onions | nested L2 session usage | L2 | 198190 | estimate | exited |
| Inventory onion Hosts | nested L2 session usage | L2 | 127836 | estimate | exited |
| Issue cert from laptop | nested L2 session usage | L2 | 69523 | estimate | exited |
...
| Per-site onion services | nested L2 session usage | L2 | 56812 | estimate | exited |
| Pin 20-name leaf docs | nested L2 session usage | L2 | 56601 | estimate | exited |
| Restore exophiles cert names | nested L2 session usage | L2 | 141403 | estimate | exited |
